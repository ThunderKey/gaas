module GaasHelper
  ...
  @@gemsurance_regex = /\A\s*Retrieving gem version information\.\.\.\s+Retrieving latest vulnerability data\.\.\.\s+Reading vulnerability data\.\.\.\s+Generating report\.\.\.\s+Generated report #{Gaas.config.private_dir}\/gemsurance_reports\/\d+\/gemsurance_report\.yml\.\s*\Z/
